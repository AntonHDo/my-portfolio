...
const Hero = () => {
  return (
    <section className="flex relative flex-col justify-center w-full h-screen text-9xl text-center bg-slate-200 text-slate-200 max-md:max-w-full max-md:text-4xl">
      <div className="flex relative flex-col px-16 pt-72 pb-56 w-full min-h-[720px] max-md:px-5 max-md:max-w-full max-md:text-6xl">
        ...
        <div className="z-10 text-6xl max-md:text-4xl">UX / UI • Developer</div>
      </div>
